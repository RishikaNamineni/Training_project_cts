...
class DrugControllerTest {
	...
	void testGetDrugById() throws Exception {
		...
		DrugDetails expected = new DrugDetails("PR1", "Drug1", "manu1", new Date(), new Date(), 20.0,list);
		...
		MvcResult result = mockMvc.perform(get("/searchDrugsById/PR1").header("Authorization", "Bearer Token")).andReturn();
	...
	void testGetDrugByName() throws Exception {
		list.add(new DrugLocationDetails("PR1", "Chennai", 30, null));
		DrugDetails expected = new DrugDetails("PR1", "Paracetamol", "manu1", new Date(), new Date(),20.0, list);
		ObjectMapper objectMapper = new ObjectMapper();
		String expectedValue = objectMapper.writeValueAsString(expected).substring(27, 37);
		ValidateToken tokenValid = new ValidateToken("uid", "uname", true);
		ResponseEntity<ValidateToken> response = new ResponseEntity<ValidateToken>(tokenValid, HttpStatus.OK);
		when(authFeign.getValidity("Bearer Token")).thenReturn(response);
		MvcResult result = mockMvc.perform(get("/searchDrugsByName/Paracetamol").header("Authorization", "Bearer Token"))
				.andReturn();
	...
	void testDispatchableDrugStock() throws Exception {
		...
		MvcResult result = mockMvc.perform(post("/getDispatchableDrugStock/PR1/Hyderabad").header("Authorization", "Bearer Token"))
				.andReturn();
	...
	void testgetAllDrugs() throws Exception {
		...
		DrugDetails expected = new DrugDetails("D1", "Drug1", "manu1", new Date(), new Date(),20.0, list);
		...
		MvcResult result = mockMvc.perform(get("/getAllDrugs").header("Authorization", "Bearer Token")).andReturn();

		String actualValue = result.getResponse().getContentAsString();

		String expectedResult = "[{\"drugId\":\"PR1\",\"drugName\":\"Paracetamol\",\"manufacturer\":\"Glaxosmithkline Ltd\",\"manufactureDate\":"
				+ "\"2020-12-21T18:30:00.000+00:00\",\"expiryDate\":\"2024-11-21T18:30:00.000+00:00\",\"cost\":50.0,\"druglocationQuantities\""
				+ ":[{\"serialId\":\"1\",\"location\":\"Chennai\",\"quantity\":500},{\"serialId\":\"2\",\"location\":"
				+ "\"Bangalore\",\"quantity\":500},{\"serialId\":\"3\",\"location\":\"Pune\",\"quantity\":500},"
				+ "{\"serialId\":\"4\",\"location\":\"Hyderabad\",\"quantity\":500}]},"
				+ "{\"drugId\":\"CR2\",\"drugName\":\"Crocin\",\"manufacturer\":\"Glaxosmithkline Ltd\","
				+ "\"manufactureDate\":\"2020-11-20T18:30:00.000+00:00\","
				+ "\"expiryDate\":\"2024-01-11T18:30:00.000+00:00\","
				+ "\"cost\":25.0,"
				+ "\"druglocationQuantities\":"
				+ "[{\"serialId\":\"5\",\"location\":\"Chennai\",\"quantity\":500},"
				+ "{\"serialId\":\"6\",\"location\":\"Bangalore\",\"quantity\":500},"
				+ "{\"serialId\":\"7\",\"location\":\"Pune\",\"quantity\":500},"
				+ "{\"serialId\":\"8\",\"location\":\"Hyderabad\",\"quantity\":500}]},"
				+ "{\"drugId\":\"DL3\",\"drugName\":\"Dolo\",\"manufacturer\":\"Glaxosmithkline Ltd\","
				+ "\"manufactureDate\":\"2020-05-11T18:30:00.000+00:00\","
				+ "\"expiryDate\":\"2024-12-01T18:30:00.000+00:00\",\"cost\":45.0,\"druglocationQuantities\""
				+ ":[{\"serialId\":\"9\",\"location\":\"Chennai\",\"quantity\":500},"
				+ "{\"serialId\":\"10\",\"location\":\"Bangalore\",\"quantity\":500}]}]";
